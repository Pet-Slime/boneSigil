...
namespace boneSigils.cards
{
	public static class Tanuki_Mythical
	{
		...
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.GetTextureFromPath("void_tanuki_mythical.png");
			Texture2D eTexture = SigilUtils.GetTextureFromPath("void_tanuki_mythical_e.png");
