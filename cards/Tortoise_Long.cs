...
namespace boneSigils.cards
{
	public static class Tortoise_Long
	{
		...
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.GetTextureFromPath("void_tortoise_long.png");
			Texture2D eTexture = SigilUtils.GetTextureFromPath("void_tortoise_long_e.png");
