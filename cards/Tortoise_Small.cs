...
namespace boneSigils.cards
{
	public static class Tortoise_Small
	{
		...
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.GetTextureFromPath("void_tortoise_spotted.png");
			Texture2D eTexture = SigilUtils.GetTextureFromPath("void_tortoise_spotted_e.png");
