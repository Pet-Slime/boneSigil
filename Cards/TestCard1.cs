...
namespace boneSigils.cards
{
	public static class TestCard1
    {
		...
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.GetTextureFromPath("Artwork/void_Camel.png");
			Texture2D eTexture = SigilUtils.GetTextureFromPath("Artwork/void_Camel_e.png");
